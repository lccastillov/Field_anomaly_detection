## ----------------------------------
### This python file contains the functions to detect in-field anomalies
## -------------------------------
...
def HistoThresholds(SegID, ClumpsArray, ImageArray, m_root, band_name, input_plot_histograms):
    ...
    for lowBin in range(lqNumBins):
        for upBin in range(uqNumBins):
            ...
            #By default, Kurtosis is calculated using Fisher's definition (normal ==> 0.0). \
